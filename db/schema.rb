...
ActiveRecord::Schema.define(version: 2021_04_22_063716) do
  ...
  create_table "paypal_commerce_platform_sources", charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "spree_adjustment_reasons", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.string "name"
    t.string "code"
  ...
  create_table "spree_cartons", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.string "number"
  ...
  create_table "spree_line_item_actions", id: :integer, charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "spree_option_values_variants", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.integer "variant_id"
  ...
  create_table "spree_order_mutexes", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.integer "order_id", null: false
    t.datetime "created_at", precision: 6
  ...
  create_table "spree_orders_promotions", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.integer "order_id"
  ...
  create_table "spree_promotion_code_batches", id: :integer, charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "spree_promotion_codes", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.integer "promotion_id", null: false
  ...
  create_table "spree_promotion_rules_stores", charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "spree_promotion_rules_users", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.integer "user_id"
    t.integer "promotion_rule_id"
    t.datetime "created_at", precision: 6
    t.datetime "updated_at", precision: 6
  ...
  create_table "spree_return_reasons", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.string "name"
    t.boolean "active", default: true
    t.boolean "mutable", default: true
    t.datetime "created_at", precision: 6
  ...
  create_table "spree_roles_users", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.integer "role_id"
    t.integer "user_id"
    t.datetime "created_at", precision: 6
    t.datetime "updated_at", precision: 6
  ...
  create_table "spree_shipping_method_stock_locations", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.integer "shipping_method_id"
    t.integer "stock_location_id"
    t.datetime "created_at", precision: 6
    t.datetime "updated_at", precision: 6
  ...
  create_table "spree_shipping_rate_taxes", id: :integer, charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "spree_store_credit_reasons", charset: "utf8mb4", force: :cascade do |t|
    t.string "name"
    t.boolean "active", default: true
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "spree_store_payment_methods", id: :integer, charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "spree_store_shipping_methods", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "store_id", null: false
  ...
  create_table "spree_tax_rate_tax_categories", id: :integer, charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "spree_unit_cancels", id: :integer, charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "spree_user_addresses", id: :integer, charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "spree_user_stock_locations", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.integer "user_id"
    t.integer "stock_location_id"
    t.datetime "created_at", precision: 6
    t.datetime "updated_at", precision: 6
  ...
  create_table "spree_variant_property_rule_conditions", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.integer "option_value_id"
  ...
  create_table "spree_variant_property_rule_values", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.text "value"
    t.integer "position", default: 0
    t.integer "property_id"
    t.integer "variant_property_rule_id"
  ...
  create_table "spree_variant_property_rules", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.integer "product_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "spree_wallet_payment_sources", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    t.integer "user_id", null: false
